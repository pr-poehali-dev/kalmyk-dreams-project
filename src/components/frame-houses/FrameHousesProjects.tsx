...
const projects = [
  ...
  {
    image: 'https://cdn.poehali.dev/projects/ba2bc4a9-4f18-428c-9910-30dd42a4e38f/files/cfabcee9-29e6-433b-97cf-05f9b48e38df.jpg',
    name: 'Поляна 120',
    area: '119.49 м²',
    livingArea: '105 м²',
...
export default function FrameHousesProjects() {
          ...
          <div className="max-w-6xl w-full" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mt-6 text-center text-white">
              ...
              <p className="text-white/90 text-lg mb-1">
                {selectedProject.galleryDescriptions?.[currentImageIndex] || selectedProject.description}
              </p>
