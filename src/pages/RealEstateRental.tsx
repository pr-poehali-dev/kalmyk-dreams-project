            ...
            <Card className="mb-8">
              <CardContent className="p-8">
                ...
                <p className="text-lg leading-relaxed">
                  Договора заключаются в основном онлайн через сервисы подписания документов физическими лицами простой электронной подписью (ПЭП) на основании ст. 5 федерального закона 63-ФЗ «Об электронной подписи» от 06.04.2011 года или по нотариальной доверенности родственником собственника.
                </p>
              </CardContent>
            </Card>
