                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="font-heading font-bold mb-1">Штаб-квартира инвестора</h4>
                        <p className="text-sm text-muted-foreground">
                          Республика Калмыкия с 23.11.2023 г. по адресу 359230, Республика Калмыкия, р-н Черноземельский, п Нарын Худук, ул 40 лет Победы, д. 12, кв. 1 переехала с 11.07.2025 на новый адрес 359404, Республика Калмыкия, р-н Сарпинский, п Каажихин, ул Зеленая, д. 20/2
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
